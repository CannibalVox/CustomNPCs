...
public class ModelCouchMiddle extends ModelBase {
   ...
   public ModelCouchMiddle() {
      ...
      this.Leg3.addBox(0.0F, 0.0F, 0.0F, 1, 1, 2);
      ...
      this.Bottom = new ModelRenderer(this, 2, 0);
      this.Bottom.addBox(0.0F, 0.0F, 0.0F, 16, 2, 14);
      this.Bottom.setRotationPoint(-8.0F, 21.0F, -6.0F);
      this.Back = new ModelRenderer(this, 14, 15);
      this.Back.addBox(0.0F, 0.0F, 0.0F, 16, 15, 1);
