...
public class ModelCouchWoodRight extends ModelBase {
   ...
   public ModelCouchWoodRight() {
      ...
      this.Shape1.setRotationPoint(6.0F, 18.0F, -4.0F);
      ...
      this.Shape3.setRotationPoint(6.0F, 14.0F, 0.5F);
      ...
      this.Shape6.setRotationPoint(6.0F, 13.0F, -7.0F);
      ...
      this.Shape17.setRotationPoint(6.0F, 14.0F, -6.0F);
      this.Shape18 = new ModelRenderer(this, 0, 0);
      this.Shape18.addBox(0.0F, 0.0F, 0.0F, 2, 18, 2);
      this.Shape18.setRotationPoint(6.0F, 6.0F, 6.0F);
   }
