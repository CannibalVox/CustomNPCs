      ...
      if(!this.base.isArmor) {
         if(part.type == 2) {
            ...
            if(this.base.isSneak) {
               super.rotationPointZ = 5.0F;
               super.rotationPointY = -1.0F;
            ...
            if(this.base.isSleeping(entity) || this.entity.currentAnimation == EnumAnimation.CRAWLING) {
               super.rotationPointY = 12.0F * this.entity.modelData.legs.scaleY;
               super.rotationPointZ = 15.0F * this.entity.modelData.legs.scaleY;
               super.rotateAngleX = -1.5707964F;
            }
         } else if(part.type == 3) {
      ...
      if(super.showModel && !super.isHidden) {
         ...
         if(part.type >= 0) {
            ...
            if(part.type == 0 || part.type == 4 && !this.entity.isInWater()) {
               this.leg1.setConfig(super.config, super.x, super.y, super.z);
               this.leg1.render(par1);
               this.leg2.setConfig(super.config, -super.x, super.y, super.z);
            ...
            if(bo) {
               float red = (float)(this.entity.modelData.legParts.color >> 16 & 255) / 255.0F;
               float green = (float)(this.entity.modelData.legParts.color >> 8 & 255) / 255.0F;
               float blue = (float)(this.entity.modelData.legParts.color & 255) / 255.0F;
