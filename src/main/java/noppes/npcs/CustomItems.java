...
public class CustomItems {
   ...
   public static void load() {
      ...
      redstoneBlock = (new BlockNpcRedstone()).setHardness(50.0F).setResistance(2000.0F).setUnlocalizedName("npcRedstoneBlock").setTextureName("customnpcs:npcRedstoneBlock").setCreativeTab(tab);
      carpentyBench = (new BlockCarpentryBench()).setUnlocalizedName("npcCarpentyBench").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeWood).setCreativeTab(tabBlocks);
      mailbox = (new BlockMailbox()).setUnlocalizedName("npcMailbox").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeMetal).setCreativeTab(tabBlocks);
      waypoint = (new BlockWaypoint()).setUnlocalizedName("npcLocationBlock").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeMetal).setTextureName("customnpcs:npcWaypoint").setCreativeTab(tab);
      border = (new BlockBorder()).setUnlocalizedName("npcBorder").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeWood).setCreativeTab(tab).setTextureName("customnpcs:npcBorder");
      ...
      BlockDispenser.dispenseBehaviorRegistry.putObject(soulstoneFull, new BehaviorDefaultDispenseItem() {
         public ItemStack dispenseStack(IBlockSource source, ItemStack item) {
            ...
            ((ItemSoulstoneFilled)CustomItems.soulstoneFull).spawn((EntityPlayer)null, item, source.getWorld(), x, source.getYInt(), z);
            item.splitStack(1);
            return item;
         }
      });
      ...
      if(!CustomNpcs.DisableExtraBlock) {
         blood = (new BlockBlood()).setUnlocalizedName("npcBloodBlock").setTextureName("customnpcs:npcBloodBlock").setCreativeTab(tabBlocks);
         banner = (new BlockBanner()).setUnlocalizedName("npcBanner").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeMetal).setCreativeTab(tabBlocks);
         wallBanner = (new BlockWallBanner()).setUnlocalizedName("npcWallBanner").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeMetal).setCreativeTab(tabBlocks);
         tallLamp = (new BlockTallLamp()).setUnlocalizedName("npcTallLamp").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeMetal).setCreativeTab(tabBlocks);
         chair = (new BlockChair()).setUnlocalizedName("npcChair").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeWood).setCreativeTab(tabBlocks);
         crate = (new BlockCrate()).setUnlocalizedName("npcCrate").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeWood).setCreativeTab(tabBlocks);
         weaponsRack = (new BlockWeaponRack()).setUnlocalizedName("npcWeaponRack").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeWood).setCreativeTab(tabBlocks);
         couchWool = (new BlockCouchWool()).setUnlocalizedName("npcCouchWool").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeWood).setCreativeTab(tabBlocks);
         table = (new BlockTable()).setUnlocalizedName("npcTable").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeWood).setCreativeTab(tabBlocks);
         couchWood = (new BlockCouchWood()).setUnlocalizedName("npcCouchWood").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeWood).setCreativeTab(tabBlocks);
         lamp = (new BlockLamp(true)).setUnlocalizedName("npcLamp").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeWood).setCreativeTab(tabBlocks);
         candle = (new BlockCandle(true)).setUnlocalizedName("npcCandle").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeWood).setCreativeTab(tabBlocks);
         stool = (new BlockStool()).setUnlocalizedName("npcStool").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeWood).setCreativeTab(tabBlocks);
         Block bronze = (new BlockPlaceholder()).setUnlocalizedName("npcPlaceholder").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeWood).setCreativeTab(tabMisc);
         bigsign = (new BlockBigSign()).setUnlocalizedName("npcBigSign").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeWood).setCreativeTab(tabBlocks);
         barrel = (new BlockBarrel()).setUnlocalizedName("npcBarrel").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeWood).setCreativeTab(tabBlocks);
         campfire = (new BlockCampfire(true)).setUnlocalizedName("npcCampfire").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeStone).setCreativeTab(tabBlocks);
         tombstone = (new BlockTombstone()).setUnlocalizedName("npcTombstone").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeStone).setCreativeTab(tabBlocks);
         shelf = (new BlockShelf()).setUnlocalizedName("npcShelf").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeWood).setCreativeTab(tabBlocks);
         sign = (new BlockSign()).setUnlocalizedName("npcSign").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeWood).setCreativeTab(tabBlocks);
         beam = (new BlockBeam()).setUnlocalizedName("npcBeam").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeWood).setCreativeTab(tabBlocks);
         book = (new BlockBook()).setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeWood).setCreativeTab(tabBlocks);
         pedestal = (new BlockPedestal()).setUnlocalizedName("npcPedestal").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeWood).setCreativeTab(tabBlocks);
         crystal = (new BlockCrystal()).setUnlocalizedName("npcCrystal").setTextureName("customnpcs:npcCrystal").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeGlass).setCreativeTab(tabBlocks);
         campfire_unlit = (new BlockCampfire(false)).setUnlocalizedName("npcCampfire").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeStone);
         lamp_unlit = (new BlockLamp(false)).setUnlocalizedName("npcLamp").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeWood);
         candle_unlit = (new BlockCandle(false)).setUnlocalizedName("npcCandle").setHardness(5.0F).setResistance(10.0F).setStepSound(Block.soundTypeWood);
         ...
         GameRegistry.registerBlock(bronze, ItemPlaceholder.class, "npcPlaceholder");
      ...
      violinbow = (new ItemNpcInterface()).setUnlocalizedName("npcViolinBow").setFull3D().setMaxStackSize(1).setCreativeTab(tabMisc).setTextureName("customnpcs:npcViolinBow");
      ...
      if(!CustomNpcs.DisableExtraItems) {
         ...
         ToolMaterial bronze1 = EnumHelper.addToolMaterial("BRONZE", 2, 170, 5.0F, 2.0F, 15);
         ...
         tridentBronze = (new ItemSpear(26845, bronze1)).setUnlocalizedName("npcBronzeTrident").setFull3D().setMaxStackSize(1).setTextureName("customnpcs:npcBronzeTrident");
         ...
         spellNature = (new ItemNpcInterface(26930)).setUnlocalizedName("npcNatureSpell").setCreativeTab(tabMisc).setTextureName("customnpcs:npcNatureSpell");
         spellArcane = (new ItemNpcInterface(26931)).setUnlocalizedName("npcArcaneSpell").setCreativeTab(tabMisc).setTextureName("customnpcs:npcArcaneSpell");
         spellLightning = (new ItemNpcInterface(26932)).setUnlocalizedName("npcLightningSpell").setCreativeTab(tabMisc).setTextureName("customnpcs:npcLightningSpell");
         spellIce = (new ItemNpcInterface(26933)).setUnlocalizedName("npcIceSpell").setCreativeTab(tabMisc).setTextureName("customnpcs:npcIceSpell");
         spellFire = (new ItemNpcInterface(26934)).setUnlocalizedName("npcFireSpell").setCreativeTab(tabMisc).setTextureName("customnpcs:npcFireSpell");
         spellDark = (new ItemNpcInterface(26935)).setUnlocalizedName("npcDarkSpell").setCreativeTab(tabMisc).setTextureName("customnpcs:npcDarkSpell");
         spellHoly = (new ItemNpcInterface(26936)).setUnlocalizedName("npcHolySpell").setCreativeTab(tabMisc).setTextureName("customnpcs:npcHolySpell");
         orb = (new ItemOrb(26937)).setUnlocalizedName("npcOrb").setCreativeTab(tabMisc).setTextureName("customnpcs:npcOrb");
         mana = (new ItemNpcInterface(26938)).setUnlocalizedName("npcMana").setCreativeTab(tabWeapon).setTextureName("customnpcs:npcMana");
         Item brokenOrb = (new ItemOrb(26939)).setUnlocalizedName("npcBrokenOrb").setCreativeTab(tabMisc).setTextureName("customnpcs:npcBrokenOrb");
         ...
         swordBronze = (new ItemNpcWeaponInterface(bronze1)).setUnlocalizedName("npcBronzeSword").setFull3D().setMaxStackSize(1).setTextureName("customnpcs:npcBronzeSword");
         ...
         Item chickenSword = (new ItemNpcInterface(26802)).setUnlocalizedName("npcChickenSword").setFull3D().setMaxStackSize(1).setCreativeTab(tabMisc).setTextureName("customnpcs:npcChickenSword");
         Item handcuffs = (new ItemNpcInterface(26803)).setUnlocalizedName("npcHandCuffs").setFull3D().setMaxStackSize(1).setCreativeTab(tabMisc).setTextureName("customnpcs:npcHandCuffs");
         ...
         Item lighter = (new ItemFlintAndSteel()).setUnlocalizedName("npcLighter").setMaxStackSize(1).setCreativeTab(tabMisc).setTextureName("customnpcs:npcLighter");
         ...
         spear = (new ItemSpear(26755, bronze1)).setUnlocalizedName("npcBronzeSpear").setFull3D().setMaxStackSize(1).setTextureName("customnpcs:npcBronzeSpear");
         ...
         halberdBronze = (new ItemSpear(26755, bronze1)).setUnlocalizedName("npcBronzeHalberd").setFull3D().setMaxStackSize(1).setTextureName("customnpcs:npcBronzeHalberd");
         ...
         battleAxeBronze = (new ItemBattleAxe(26765, bronze1)).setUnlocalizedName("npcBronzeBattleAxe").setFull3D().setMaxStackSize(1).setTextureName("customnpcs:npcBronzeBattleAxe");
         ...
         warhammer = (new ItemWarhammer(26765, bronze1)).setUnlocalizedName("npcBronzeWarhammer").setFull3D().setMaxStackSize(1).setTextureName("customnpcs:npcBronzeWarhammer");
         ...
         mace = (new ItemNpcWeaponInterface(26775, bronze1)).setUnlocalizedName("npcBronzeMace").setFull3D().setMaxStackSize(1).setTextureName("customnpcs:npcBronzeMace");
         ...
         dagger = (new ItemDagger(26710, bronze1)).setUnlocalizedName("npcBronzeDagger").setFull3D().setMaxStackSize(1).setTextureName("customnpcs:npcBronzeDagger");
         dagger = (new ItemDaggerReversed(26711, (ItemDagger)dagger, bronze1)).setUnlocalizedName("npcBronzeReversedDagger").setFull3D().setMaxStackSize(1).setTextureName("customnpcs:npcBronzeDagger");
         ...
         scythe = (new ItemScythe(26797, bronze1)).setUnlocalizedName("npcBronzeScythe").setFull3D().setMaxStackSize(1).setTextureName("customnpcs:npcBronzeScythe");
         ...
         glaiveBronze = (new ItemGlaive(26795, bronze1)).setUnlocalizedName("npcBronzeGlaive").setFull3D().setMaxStackSize(1).setTextureName("customnpcs:npcBronzeGlaive");
         ...
         (new ItemBroadSword(bronze1)).setUnlocalizedName("npcBronzeBroadsword").setFull3D().setMaxStackSize(1).setTextureName("customnpcs:npcBronzeBroadsword");
         ...
         ArmorMaterial armorMithril = EnumHelper.addArmorMaterial("MITHRIL", 40, new int[]{3, 8, 6, 3}, 20);
         ArmorMaterial armorBronze = EnumHelper.addArmorMaterial("BRONZE", 7, new int[]{2, 6, 5, 2}, 20);
         ArmorMaterial armorEmerald = EnumHelper.addArmorMaterial("EMERALD", 35, new int[]{5, 7, 4, 5}, 5);
         ...
         coinWood = (new ItemNpcInterface(26717)).setUnlocalizedName("npcCoinWooden").setCreativeTab(tabMisc).setTextureName("customnpcs:npcCoinWooden");
         coinStone = (new ItemNpcInterface(26718)).setUnlocalizedName("npcCoinStone").setCreativeTab(tabMisc).setTextureName("customnpcs:npcCoinStone");
         coinBronze = (new ItemNpcInterface(26719)).setUnlocalizedName("npcCoinBronze").setCreativeTab(tabMisc).setTextureName("customnpcs:npcCoinBronze");
         coinIron = (new ItemNpcInterface(26720)).setUnlocalizedName("npcCoinIron").setCreativeTab(tabMisc).setTextureName("customnpcs:npcCoinIron");
         coinGold = (new ItemNpcInterface(26721)).setUnlocalizedName("npcCoinGold").setCreativeTab(tabMisc).setTextureName("customnpcs:npcCoinGold");
         coinDiamond = (new ItemNpcInterface(26722)).setUnlocalizedName("npcCoinDiamond").setCreativeTab(tabMisc).setTextureName("customnpcs:npcCoinDiamond");
         coinEmerald = (new ItemNpcInterface(26723)).setUnlocalizedName("npcCoinEmerald").setCreativeTab(tabMisc).setTextureName("customnpcs:npcCoinEmerald");
         Item quest = (new ItemNpcInterface()).setUnlocalizedName("npcAncientCoin").setCreativeTab(tabMisc).setTextureName("customnpcs:npcAncientCoin");
         letter = (new ItemNpcInterface(26950)).setUnlocalizedName("npcLetter").setCreativeTab(tabMisc).setTextureName("customnpcs:npcLetter");
         quest = (new ItemNpcInterface(26951)).setUnlocalizedName("npcPlans").setCreativeTab(tabMisc).setTextureName("customnpcs:npcPlans");
         satchel = (new ItemNpcInterface(26952)).setUnlocalizedName("npcSatchel").setCreativeTab(tabMisc).setTextureName("customnpcs:npcSatchel");
         bag = (new ItemNpcInterface(26953)).setUnlocalizedName("npcBag").setCreativeTab(tabMisc).setTextureName("customnpcs:npcBag");
         quest = (new ItemNpcInterface(26954)).setUnlocalizedName("npcCrystal").setCreativeTab(tabMisc).setTextureName("customnpcs:npcCrystal");
         quest = (new ItemNpcInterface(26955)).setUnlocalizedName("npcSeveredEar").setCreativeTab(tabMisc).setTextureName("customnpcs:npcSeveredEar");
         quest = (new ItemNpcInterface(26956)).setUnlocalizedName("npcPhone").setCreativeTab(tabMisc).setTextureName("customnpcs:npcPhone");
         quest = (new ItemNpcArmor(26957, ArmorMaterial.IRON, 0, "mask")).setMaxStackSize(64).setUnlocalizedName("npcBanditMask").setCreativeTab(tabArmor).setTextureName("customnpcs:npcBanditMask");
         quest = (new ItemNpcInterface(26958)).setUnlocalizedName("npcBrokenArrow").setCreativeTab(tabMisc).setTextureName("customnpcs:npcBrokenArrow");
         quest = (new ItemNpcInterface(26959)).setUnlocalizedName("npcEarthElement").setCreativeTab(tabMisc).setTextureName("customnpcs:npcEarthElement");
         quest = (new ItemNpcInterface(26960)).setUnlocalizedName("npcWaterElement").setCreativeTab(tabMisc).setTextureName("customnpcs:npcWaterElement");
         quest = (new ItemNpcInterface(26961)).setUnlocalizedName("npcFireElement").setCreativeTab(tabMisc).setTextureName("customnpcs:npcFireElement");
         quest = (new ItemNpcInterface(26962)).setUnlocalizedName("npcAirElement").setCreativeTab(tabMisc).setTextureName("customnpcs:npcAirElement");
         quest = (new ItemNpcInterface(26963)).setUnlocalizedName("npcCarKey").setCreativeTab(tabMisc).setTextureName("customnpcs:npcCarKey");
         quest = (new ItemNpcInterface(26964)).setUnlocalizedName("npcKey").setCreativeTab(tabMisc).setTextureName("customnpcs:npcKey");
         quest = (new ItemNpcInterface(26965)).setUnlocalizedName("npcKey2").setCreativeTab(tabMisc).setTextureName("customnpcs:npcKey2");
         quest = (new ItemNpcInterface(26966)).setUnlocalizedName("npcPendant").setCreativeTab(tabMisc).setTextureName("customnpcs:npcPendant");
         quest = (new ItemNpcInterface(26967)).setUnlocalizedName("npcBlueprint").setCreativeTab(tabMisc).setTextureName("customnpcs:npcBlueprint");
         quest = (new ItemNpcInterface(26968)).setUnlocalizedName("npcRing").setCreativeTab(tabMisc).setTextureName("customnpcs:npcRing");
         quest = (new ItemNpcInterface(26969)).setUnlocalizedName("npcSkull").setCreativeTab(tabMisc).setTextureName("customnpcs:npcSkull");
         Item sapphire = (new ItemNpcInterface(26970)).setUnlocalizedName("npcSaphire").setCreativeTab(tabMisc).setTextureName("customnpcs:npcSaphire");
         Item ruby = (new ItemNpcInterface(26971)).setUnlocalizedName("npcRuby").setCreativeTab(tabMisc).setTextureName("customnpcs:npcRuby");
         Item amethyst = (new ItemNpcInterface(26972)).setUnlocalizedName("npcAmethyst").setCreativeTab(tabMisc).setTextureName("customnpcs:npcAmethyst");
         ...
         bronze_ingot = (new ItemNpcInterface(26973)).setUnlocalizedName("npcBronzeIngot").setCreativeTab(tabMisc).setTextureName("customnpcs:npcBronzeIngot");
         demonic_ingot = (new ItemNpcInterface(26973)).setUnlocalizedName("npcDemonicIngot").setCreativeTab(tabMisc).setTextureName("customnpcs:npcDemonicIngot");
         mithril_ingot = (new ItemNpcInterface(26973)).setUnlocalizedName("npcMithrilIngot").setCreativeTab(tabMisc).setTextureName("customnpcs:npcMithrilIngot");
         armorMithril.customCraftingMaterial = mithril_ingot;
         bronze1.customCraftingMaterial = bronze_ingot;
         ...
         quest = (new ItemNpcInterface()).setUnlocalizedName("npcAncientScroll").setCreativeTab(tabMisc).setTextureName("customnpcs:npcAncientScroll");
         quest = (new ItemNpcInterface()).setUnlocalizedName("npcArtifact").setCreativeTab(tabMisc).setTextureName("customnpcs:npcArtifact");
         quest = (new ItemNpcInterface()).setUnlocalizedName("npcLocket").setCreativeTab(tabMisc).setTextureName("customnpcs:npcLocket");
         quest = (new ItemNpcInterface()).setUnlocalizedName("npcSilk").setCreativeTab(tabMisc).setTextureName("customnpcs:npcSilk");
         quest = (new ItemNpcInterface()).setUnlocalizedName("npcStatuette").setCreativeTab(tabMisc).setTextureName("customnpcs:npcStatuette");
         quest = (new ItemNpcInterface()).setUnlocalizedName("npcTablet").setCreativeTab(tabMisc).setTextureName("customnpcs:npcTablet");
         quest = (new ItemNpcInterface()).setUnlocalizedName("npcHeart").setCreativeTab(tabMisc).setTextureName("customnpcs:npcHeart");
         quest = (new ItemNpcInterface()).setUnlocalizedName("npcMoney").setCreativeTab(tabMisc).setTextureName("customnpcs:npcMoney");
         quest = (new ItemNpcInterface()).setUnlocalizedName("npcNecklace").setCreativeTab(tabMisc).setTextureName("customnpcs:npcNecklace");
         quest = (new ItemNpcInterface()).setUnlocalizedName("npcUsbStick").setCreativeTab(tabMisc).setTextureName("customnpcs:npcUsbStick");
